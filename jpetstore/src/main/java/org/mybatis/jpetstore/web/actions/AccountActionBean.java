...
public class AccountActionBean extends AbstractActionBean {
	...
	private static final long serialVersionUID = 2065757107748359038L;
	...
	@Validate(required=true, on={"signon", "newAccount", "editAccouunt"})
	...
	public Resolution signon(){
		...
		if (account == null){
			...
			//this bean is already registred as /actions/Account.action
	...
	public boolean isAuthenticated(){
		return this.authenticated && account != null  && account.getUsername() != null;
	}
